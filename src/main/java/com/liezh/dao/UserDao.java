...
public interface UserDao {
    ...
    Integer followMapping(@Param("fansId") Long fansId, @Param("idolId") Long idolId);

    Integer unfollowMapping(@Param("fansId") Long fansId, @Param("idolId") Long idolId);
    ...
    Integer insertUserRoleMapping(@Param("userId") Long userId, @Param("roleId") Long roleId);
}
