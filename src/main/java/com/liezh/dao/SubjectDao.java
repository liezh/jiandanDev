...
public interface SubjectDao {
    ...
    Integer insertSubjectRecipeMapping(@Param("subjectId") Long subjectId, @Param("recipeId") Long recipeId);

    Integer updateSubjectRecipeMappingStatus(@Param("subjectId") Long subjectId, @Param("recipeId") Long recipeId, @Param("status") Integer status);
    ...
    Integer collectMapping(@Param("userId") Long userId, @Param("subjectId") Long subjectId);

    Integer uncollectMapping(@Param("userId") Long userId, @Param("subjectId") Long subjectId);

    List<SubjectInfoDto> getAllFavorite(Long userId);
