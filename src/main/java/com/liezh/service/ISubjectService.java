...
public interface ISubjectService {
    ...
    ServerResponse<PageInfo> getPassRecipeBySubjectId(Long myId, Long subjectId, Integer pageNum, Integer pageSize);
...
//    ServerResponse<PageInfo> getSubjectByRecipeId(Long recipeId, Integer pageNum, Integer pageSize);
    ...
    ServerResponse collect(Long myId, Long subjectId);

    ServerResponse uncollect(Long myId, Long subjectId);

    ServerResponse<PageInfo> getAllFavorite(Long myId, Integer pageNum, Integer pageSize);
